...
SUPPORT_CHAT_ID = int(environ.get('SUPPORT_CHAT_ID', '-100'))
REQST_CHANNEL_ID = int(environ.get('REQST_CHANNEL_ID', '-100'))
REQST_CHANNEL = REQST_CHANNEL_ID # Alignment for multiple imports
...
if 'DYNO' in environ:
    URL = "https://{}.herokuapp.com/".format(APP_NAME) if APP_NAME else f"https://{FQDN}/"
else:
    URL = f"https://{FQDN}/" if NO_PORT else f"https://{FQDN}:{PORT}/"

# Final SSL/Import Alignment
